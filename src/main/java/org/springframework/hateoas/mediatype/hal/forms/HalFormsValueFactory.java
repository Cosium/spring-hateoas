...
class HalFormsValueFactory {
	...
	private final Map<Class<?>, Map<String, Function<AffordanceModel.PropertyMetadata, Object>>> values;
	 ...
	 */
	private HalFormsValueFactory(Map<Class<?>, Map<String, Function<AffordanceModel.PropertyMetadata, Object>>> values) {
		this.values = values;
	}
	...
	HalFormsValueFactory withValues(Class<?> type, String property,
									   Function<AffordanceModel.PropertyMetadata, Object> creator) {
		...
		Map<Class<?>, Map<String, Function<AffordanceModel.PropertyMetadata, Object>>> values = new HashMap<>(this.values);
	...
	Object getValue(AffordanceModel.PayloadMetadata payload, AffordanceModel.PropertyMetadata property) {
		...
		Map<String, Function<AffordanceModel.PropertyMetadata, Object>> map = values.get(type);

		if (map == null) {
			return null;
		}

		Function<AffordanceModel.PropertyMetadata, Object> function = map.get(name);
